...
// const ERC777 = artifacts.require('MetaStudioToken');
...
//     const initialSupply = new BN('5000000000');
...
//                                 this.recipient,
//                                 web3.utils.soliditySha3('ERC777TokensRecipient'), this.tokensRecipientImplementer.address, { from: this.recipient },
//                             );
//                         });
...
//                         await this.erc1820.setInterfaceImplementer(
//                             this.sender,
//                             web3.utils.soliditySha3('ERC777TokensSender'), this.tokensSenderImplementer.address, { from: this.sender },
//                         );
//                     });
