...
export class IERC1363ReceiverUpgradeable__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): IERC1363ReceiverUpgradeable {
    return new Contract(address, _abi, signerOrProvider) as IERC1363ReceiverUpgradeable;
  }
}
